package com.sirui.inquiry.hospital.avchat.receiver;
...
public class PhoneCallStateObserver {
    ...
    public void onCallStateChanged(String state) {
        SRLog.i(TAG, "onCallStateChanged, now state =" + state);
    ...
    public void handleLocalCall() {
        SRLog.i(TAG, "notify phone state changed, state=" + stateEnum.name());
    ...
    public void observeAutoHangUpForLocalPhone(Observer<Integer> observer, boolean register) {
        SRLog.i(TAG, "observeAutoHangUpForLocalPhone->" + observer + "#" + register);
