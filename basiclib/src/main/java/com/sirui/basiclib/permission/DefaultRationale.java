...
/**
 * author: hewei
 * created on: 2018/3/23 16:48
 * description:权限拒绝后的提示
 */
public class DefaultRationale implements Rationale {
    ...
    public void showRationale(Context context, List<String> permissions, final RequestExecutor executor) {
        ...
        PermissionDialogUtils.permissionDialogShow(context, true, R.string.title_dialog, message, R.string.resume, R.string.cancel, new DialogInterface.OnClickListener() {
            @Override
